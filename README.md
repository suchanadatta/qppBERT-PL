...
We provide a [model checkpoint](https://drive.google.com/drive/folders/1xWtQr7hQATYioJVIDdQBJSClbrZb--qv?usp=sharing) (model-200000.zip) trained on TREC-DL-2019 + TREC-DL-2020 + a sample of MS MARCO train set in [here](https://microsoft.github.io/msmarco/). To evaluate the model performance on [TREC-DL-2021](https://microsoft.github.io/msmarco/TREC-Deep-Learning-2021) topic set,  
