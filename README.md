...
2. [Collection](https://drive.google.com/file/d/1mxP4OMbXXk9BLaePF5pkc3lx4gb4jlNZ/view?usp=sharing) - MS MARCO Passage (v2) if not loading from [ir-datasets](https://ir-datasets.com/). You can get the [pickle](https://drive.google.com/file/d/12dcXWHiJy0adTuhHWw72DobjZUQDWP0j/view?usp=share_link) dump in here.
3. [Trained model](https://drive.google.com/file/d/1XHcLgpkfWd3XnaQ5YKTkFdCqrU8-wGeO/view?usp=sharing)
